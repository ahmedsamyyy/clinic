						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">كشوفات </h4>
									...
									<table class="table text-md-nowrap" id="example1">
										...
										<tbody>
                                            ...
                                            <tr>
												...
												<td>{{$item->analysis}}</td>
                                                <td>{{$item->rumores}}</td>
                                                <td><a  class="btn btn-success" href="{{route('detetion.restore',$item->id)}}" role="button">استعادة</a></td>
                                                <td>
                                                    <a  class="btn btn-danger" href="{{route('detetion.hard.delete',$item->id)}}" role="button">حذف نهائي</a>
                                                </td>
