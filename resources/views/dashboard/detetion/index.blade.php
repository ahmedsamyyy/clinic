					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0">
								...
								<a name="add" id="" class="btn btn-success" href="{{route('detetion.create')}}" role="button">اضافة</a>
                                <a id="" class="btn btn-danger" href="{{route('detetion.trash')}}" role="button">ارشيف الحذف</a>
