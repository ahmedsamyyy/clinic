									...
									<table class="table text-md-nowrap" id="example1">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->address}}</td>
                                                <td><a  class="btn btn-success" href="{{route('patient.restore',$item->id)}}" role="button">استعادة</a></td>
                                                <td>
                                                    <a  class="btn btn-danger" href="{{route('patient.hard.delete',$item->id)}}" role="button">حذف نهائي</a>
                                                </td>
